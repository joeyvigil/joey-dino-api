...
class DinoModel(BaseModel):
    id: Annotated[Optional[int], Field(gt=0)] = None # gt=0 means value must be greater than 0.  = None means that this field is optional and will be set to None if not provided.
    species: str
    period: str
